...
function ErrorScreen({ title, message, email }) {
  return (
    <div style={{
      ...
      justifyContent: 'center', background: 'var(--navy)', padding: '2rem',
    }}>
      <div style={{
        ...
        <div style={{
          width: 56, height: 56, background: 'var(--amber-bg)',
          borderRadius: '50%', display: 'flex', alignItems: 'center',
          justifyContent: 'center', margin: '0 auto 1.25rem', fontSize: '1.5rem',
        }}>⚠️</div>
        <h2 style={{ fontSize: '1.4rem', color: 'var(--cream)', marginBottom: '.5rem', fontFamily: 'var(--font-display)' }}>
          {title}
        </h2>
        <p style={{ color: 'var(--slate)', fontSize: '.88rem', lineHeight: 1.7, marginBottom: '1.5rem' }}>
          {message}
        </p>
        {email && (
          <div style={{
            background: 'var(--navy-light)', border: '1px solid rgba(201,168,76,.15)',
            borderRadius: 'var(--radius-md)', padding: '1rem', marginBottom: '1.75rem',
          }}>
        ...
        <button
          ...
          style={{
            background: 'transparent', border: '1px solid rgba(138,155,181,.3)',
            borderRadius: 'var(--radius-sm)', color: 'var(--slate-light)',
...
function FullPageLoader() {
  return (
    <div style={{
      ...
      gap: '1.25rem', background: 'var(--navy)',
    }}>
